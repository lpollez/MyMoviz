...
export default class Movie extends Component {
  ...
  constructor(props){
    ...
    handleClick(){
      ...
      if (isLike) {
        ...
        fetch(`http://localhost:3001/mymovies/${this.props.idMovie}`, {
          method: 'DELETE'})
          .catch((error) => {
          console.error(error);
        });
  ...
  componentDidMount() {
    console.log('componentDidMount Movie appelé !');
  }

  // componentWillReceiveProps(nextProps, nextContext) {
  //   console.log('componentWillReceiveProps Movie appelé !');
  // }

  componentDidUpdate() {
    console.log('componentDidUpdate Movie appelé !');
  }
            ...
            <div style={{marginBottom:30}}>
              <Card>
                ...
                <FontAwesomeIcon onClick={this.handleClick} size="2x" style={styleHeart} icon={faHeart} />
                  <CardBody style={{height: 250, overflow:"auto"}}>
